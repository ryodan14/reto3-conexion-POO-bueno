public class Inserts {
    ...
    static String[] Direccion = {"AVENIDA DE LOS PINOS", "TERRENOS DE LOS ARCOS", "RESIDENCIAL LOS SAUCES", "CALLE DE LOS OLIVOS", "PASEO MARÍTIMO", "AVENIDA DE LA CONSTITUCIÓN", "AVENIDA CENTRAL", "RONDA DEL BOSQUE", "PASEO MARÍTIMO", "PASEO DE LA ALAMEDA", "CALLEJÓN DE LA LUNA", "CALLE DE SAN MIGUEL", "AVENIDA DE LA CONSTITUCIÓN", "CALLEJÓN DEL ÁGUILA", "CALLE DEL POZO", "CALLE DE LOS NARANJOS", "BARRIO DE SAN ANDRÉS", "RONDA DE LAESPERANZA", "URBANIZACIÓN EL MIRADOR"};
    ...
    public static void main(String[] args) {
        for (int i = 0; i < Nombres.length; i++) {
            String sql = String.format(
                ...
                Nombres[i], Apellidos[i], Direccion[i], tlfn[i], correo[i], usuario[i], contraseña[i], seguridad_social[i]
            );
    }
    }
}
